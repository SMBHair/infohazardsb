...
namespace StorybrewScripts
{
    public class Particles : StoryboardObjectGenerator
    {
        ...
        [Description("Cutoff end time")] // so that abrupt cuts can be made
        [Configurable] public int CutoffTime = 0;
        ...
        [Configurable] public int Rotating = 0;
        ...
        public override void Generate()
        {
            ...
            for (var i = 0; i < ParticleCount; i++)
            {
                ...
                if (CutoffTime != 0)
                {
                    particle.Fade(CutoffTime, (int)(Beatmap.HitObjects.LastOrDefault()?.EndTime ?? AudioDuration), 0, 0);
                }
                if (Rotating != 0)
                {
                    particle.Rotate(startTime, endTime, 0, 6.28);
                }
            }
        }
